...
#define STRING_CONFIG_H_AUTHOR "(peek_goa,Muthu)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  14.0,  22.20 }
    #define DEFAULT_Ki_LIST {    0.5,   1.08 }
    #define DEFAULT_Kd_LIST { 125.00, 114.00 }
  #else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1100, 450 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 150, 150, 2000, 1000 }
